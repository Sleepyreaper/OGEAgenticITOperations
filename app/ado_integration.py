...
The Inspector classifies policy violations → The Roughneck generates fix code →
...
Full Flow:
  ...
  2. For policy bugs: Roughneck generates Terraform/policy-as-code fix
  3. System creates a PROPOSAL with the fix code attached
  4. Human reviews proposal in the Ops Council UI
...
class AdoClient:
    ...
    def create_branch_and_push(
        ...
        Args:
            branch_name: e.g. "ops-council/policy-fix-abc123"
    ...
    def execute_pr_proposal(self, proposal: "AdoProposal") -> dict:
        ...
        commit_msg = (
            ...
            f"Auto-generated by Ops Council. Human review required."
        )
        ...
        pr_description = (
            ...
            f"---\n"
            f"*Auto-generated by the OGE Ops Council. "
        ...
        pr_result = self.create_pull_request(
            ...
            title=f"[Ops Council] {proposal.title}",
...
def parse_remediation_to_file_changes(remediation_text: str, policy_name: str = "") -> list[dict]:
    """Parse The Roughneck's remediation output into file changes for a PR.

    The Roughneck generates code blocks labeled main.tf, variables.tf,
